        ...
        <div className="flex gap-6">
            ...
            <div className="flex flex-col flex-1">
                ...
                <div className="flex items-center gap-3 mt-2">
                    <button className="btn btn-sm btn-outline capitalize btn-error">Remove</button>
                    <button className="btn btn-sm btn-outline capitalize btn-primary">Save for later</button>
                </div>
            </div>
