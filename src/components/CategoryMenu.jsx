            ...
            <div className="layout-w px-2">
                <div className="py-3">
                    <ul className="flex items-center gap-6 text-sm">
                        <Link
                            href={"/categories"}
                            className="hover:text-green-700 opacity-70 transition-opacity flex items-center gap-2"
                        >
                        ...
                        {CATEGORY_LINKS.map((cat, idx) => (
                            <div key={cat.path + idx} className="relative">
                                <a
                                    href={cat.path}
                                    className="hover:text-green-700 opacity-70  transition-opacity cursor-pointer"
                                    onClick={(e) => {
                                        e.preventDefault();
